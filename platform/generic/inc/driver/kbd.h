#ifndef	__MIMOSA_PC32_KEYBOARD_H
#define __MIMOSA_PC32_KEYBOARD_H
...
// FIXME: I need this scancode-set in a config module.
#define KBD_SCANCODE_SET 1

//-------Protocal Scancodes
#if (KBD_SCANCODE_SET == 1)
#define KBD_ERR	0xFF
#else
#define KBD_ER	0x00
#endif
...
#define KBD_ACK		0xFA
#define	KBD_ACK_FAIL	0xFE
#define KBD_E0		0xE0
//--------


// control keycodes
#define KEY_SHIFT	_B(0)
#define KEY_CTRL	_B(1)
#define KEY_ALT		_B(2)
#define KEY_CAPSLOCK	_B(3)
#define KEY_NUMLOCK	_B(4)
#define KEY_SCROLLLOCK	_B(5)
#define KEY_E0ESC	_B(6)
